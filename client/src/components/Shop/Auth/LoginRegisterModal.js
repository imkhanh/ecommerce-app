...
const LoginRegisterModal = () => {
	...
	return (
		<div>
			<div onClick={() => dispatch({ type: 'loginRegisterModal', payload: false })} className={`${data.loginRegisterModal ? '' : 'hidden'} fixed inset-0 w-full h-full backdrop-blur-sm bg-black/20 z-40`} />
